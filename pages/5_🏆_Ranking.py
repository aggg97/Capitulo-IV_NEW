...
# ── Helper para tablas dinámicas (estilo código viejo) ────────────────────────

def make_yearly_top_table(df, group_cols, agg_dict, sort_col, ascending, head_n, rename_map):
    """
    Arma tabla multi-año con año visible solo en la primera fila del grupo.
    group_cols: lista de columnas para groupby (ej: ['start_year','sigla','empresaNEW'])
    """
...
tab_graficos, tab_tablas = st.tabs(["📈 Gráficos", "📊 Tablas Dinámicas"])


# ════════════════════════════════════════════════════════════════════════════
# TAB 1 — GRÁFICOS (contenido original sin cambios)
# ════════════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════════════
# TAB 2 — TABLAS DINÁMICAS (top 3 por campaña, multi-año, estilo código viejo)
# ════════════════════════════════════════════════════════════════════════════
...
with tab_tablas:
    ...
    # ── Agente de Sostén por Volumen Inyectado ────────────────────────────────
